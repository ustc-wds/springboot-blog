...
public interface UserService {
     ...
     * @return 用户
     */
    User findUserByEmail(String phone);
     ...
     * @return 用户id
     */
    int findUserIdByEmail(String phone);
     ...
     * @param password 密码
     */
    void updatePasswordByEmail(String phone, String password);
     ...
     * @return 用户名
     */
    User findUsernameByEmail(String phone);
