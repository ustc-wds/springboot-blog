...
import com.hyf.constant.OSSClientConstants;
...
public class AliYunOSSClientUtil {
    private static Logger log = LoggerFactory.getLogger(AliYunOSSClientUtil.class);
    ...
    static{
        ...
        ACCESS_KEY_ID = "LTAI4GHHEFojUKnMhPg47J4M";
        ACCESS_KEY_SECRET="NVO3pPnMRvzJqVyc2bQWw5JzZL9tz5";
    }
    ...
    public static void main(String[] args) {
        ...
        createBucketName(ossClient,"test");
    }
}
